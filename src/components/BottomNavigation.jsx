...
export default function BottomNavigation({ rol }) {
    ...
    return <div  className={`fixed w-screen left-0 bottom-0 w-screen grid h-[70px] lg:hidden grid-cols-5  bg-gradient-to-tr from-[#00195c] via-[#274492] to-[#00195c] border-t-[5px] border-white mx-auto font-medium z-50`}>
        ...
        <Button click={() => redirectHandler(`${user && user !== undefined ?'/Login' : ''}`)} name={'Productos'}>
            <svg  className="w-11 h-11 mb-1 text-gray-600 redrounded-full  p-1" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
            </svg>
            <span  className="text-[12px] text-white   ">Calculadora</span>
        </Button>
        ...
        <Button click={() => redirectHandlerWindow(`https://api.whatsapp.com/send?phone=+59176586948&text=hola%20Logistics%20Gear`)}>
